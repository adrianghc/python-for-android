...
class PySideRecipe(PythonRecipe):
    version = '6.3.1'
    wheel_path = '/home/adrianghc/wheels/PySide6-6.3.1-6.3.1-cp36-abi3-android_x86_64.whl'
    depends = ['shiboken6']
    ...
    def build_arch(self, arch):
        ...
        libs_path = '/home/adrianghc/qt-examples/python-android-2/build/android-build/libs/x86_64'
        for root, dirs, files in os.walk(libs_path):
            for file in files:
                if 'libplugins_' in file or 'libaddressbook' in file or 'libc++_shared' in file:
                    ...
                    shutil.copyfile(join('/home/adrianghc/qt-examples/python-android-2/build/android-build/libs/x86_64',file),
